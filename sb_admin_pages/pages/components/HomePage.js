            ...
            <div className="row">
                ...
                <div className="col-xl-8 col-lg-7">
                    <div className="card shadow mb-4">
                        ...
                        {/* Card Body */}
                        <div className="card-body">
                            <img className="img-fluid px-3 px-sm-4 mt-3 mb-4" style={{ width: "1037px", height: "245px" }}
                                src="img/earning.png" alt="..." />
                        </div>
                ...
                <div className="col-xl-4 col-lg-5">
                    <div className="card shadow mb-4">
                        ...
                        <div className="card-body">
                            ...
                            <img className="img-fluid px-3 px-sm-4 mt-3 mb-4" style={{ width: "486px", height: "200px" }}
                                src="img/revenue.png" alt="..." />
